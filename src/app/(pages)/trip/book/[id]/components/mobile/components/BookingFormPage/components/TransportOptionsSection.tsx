...
export default function TransportOptionsSection({ isOpen, onToggle }: TransportOptionsSectionProps) {
    const { addOns, selectedTransportAddOnIdx, setSelectedTransportAddOnIdx } = useBookingFormStore();
        ...
        <CollapsibleCard title="Transport Options" overflow="visible" isOpen={isOpen} onToggle={onToggle}>
            <div className="flex flex-col gap-5 px-4 pb-4">
                {filteredAddOns.map((addOn) => {
                    ...
                    const isSelected = selectedTransportAddOnIdx === originalIdx;
                    return (
                        <SelectableItem
                            key={originalIdx}
                            ...
                            onClick={() => {
                                ...
                                setSelectedTransportAddOnIdx(newIdx);
                            }}
                            label={addOn.label}
