...
export default function TripDetail() {
  ...
  return (
    <div className="min-h-screen">
      <div className="flex flex-col mx-20 py-4">
      <BackButton className="mb-3"/>
        <div className="space-y-2 flex-1">
          <h1 className="text-5xl mb-4 font-medium">{tripData.title}</h1>
        </div>
        <div className="grid lg:grid-cols-4 gap-6">
          <div className="lg:col-span-3 space-y-8">
            <div className="flex gap-4 mb-4">
              {tripData.tags.map((item) => <Card key={item} variant='fill' className="rounded-full px-3.5 py-1.5 font-medium text-sm border!">{item}</Card>)}
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="mt-2 font-medium">{tripData.description}</p>
                </div>
