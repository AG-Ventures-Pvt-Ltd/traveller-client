...
export const WHATSAPP_PHONE_NUMBER = '919667427187';
/** Height of the site sticky navbar in px — tab nav sits below this. */
export const TAB_NAV_TOP = 72;
/** Top offset for the sticky booking panel (navbar + tab nav + gap). */
export const PANEL_STICKY_TOP = 160;
