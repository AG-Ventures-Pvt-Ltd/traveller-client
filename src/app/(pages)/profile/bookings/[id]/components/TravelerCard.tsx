    ...
    <div className="px-5 pt-5 pb-1 bg-neutral-50 rounded-2xl border border-gray-200 flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 gap-5">
        <div className="flex flex-col gap-1">
          <p className="text-neutral-700 text-xs font-medium font-['Satoshi']">Full Name</p>
          <p className="text-neutral-900 text-sm font-bold font-['Satoshi']">{traveler.fullName}</p>
        </div>
        <div className="flex flex-col gap-1">
