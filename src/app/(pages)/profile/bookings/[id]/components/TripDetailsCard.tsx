  ...
  return (
    <div className="bg-white rounded-3xl border-2 border-gray-200 overflow-hidden">
      <div className="flex flex-col md:flex-row">
        {/* Image */}
        <div className="relative w-full md:w-80 h-60 flex-shrink-0">
          <MyImage
            src={trip.image}
            alt={trip.title}
            fill
        ...
        <div className="flex-1 px-6 md:px-8 py-6 md:py-8 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <InfoItem icon={Calendar} label="Date" value={trip.date} />
          ...
          <div className="px-4 pt-3 pb-2 bg-neutral-50 rounded-xl">
            ...
            <p className="text-neutral-900 text-sm font-bold font-['Satoshi'] mt-0.5">{trip.createdAt}</p>
          </div>
        </div>
      </div>
    </div>
