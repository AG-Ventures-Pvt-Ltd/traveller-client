    ...
    <div className="flex flex-col min-h-screen bg-white">
      <section className="flex flex-col lg:flex-row px-4 sm:px-6 lg:px-12 pt-8 sm:pt-12 bg-gradient-to-b from-neutral-50 to-white border-b-2 border-gray-200 justify-between pb-12 sm:pb-20">
        <div className="flex flex-col gap-4 sm:gap-6 lg:w-1/2">
          ...
          <div className="text-neutral-900 text-3xl sm:text-4xl lg:text-6xl font-bold font-['Satoshi'] leading-tight lg:leading-[70.40px]">What Wondrr Is</div>
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl outline-2 outline-offset-[-1.84px] outline-gray-200 p-4 sm:p-7 max-w-2xl">
            <div className="text-neutral-900 text-sm sm:text-base font-bold font-['Satoshi'] leading-5 sm:leading-6">Wondrr does not sell travel experiences.</div>
      ...
      {/* <section className="flex flex-col px-4 sm:px-8 lg:px-32 pt-12 sm:pt-16 lg:pt-24 pb-12 sm:pb-16 lg:pb-20 bg-white border-b-2 border-gray-200">
        <div className="flex flex-col gap-8 sm:gap-12 lg:gap-16">
          <div className="text-center">
            <div className="text-neutral-900 text-3xl sm:text-4xl lg:text-5xl font-bold font-['Satoshi'] leading-tight lg:leading-[52.80px]">The Problem</div>
      ...
      <section className="flex flex-col px-4 sm:px-8 lg:px-32 pt-12 sm:pt-16 lg:pt-24 pb-12 sm:pb-16 lg:pb-20 bg-gradient-to-b from-neutral-50 to-white border-b-2 border-gray-200">
        <div className="flex flex-col gap-8 sm:gap-12 lg:gap-16">
          <div className="text-center">
            <div className="text-neutral-900 text-3xl sm:text-4xl lg:text-5xl font-bold font-['Satoshi'] leading-tight lg:leading-[52.80px]">The Wondrr Approach</div>
      ...
      <section className="flex flex-col px-4 sm:px-8 lg:px-32 pt-12 sm:pt-16 lg:pt-24 pb-12 sm:pb-16 lg:pb-20 bg-white border-b-2 border-gray-200">
        <div className="flex flex-col gap-8 sm:gap-12 lg:gap-16">
          <div className="text-center">
            <div className="text-neutral-900 text-3xl sm:text-4xl lg:text-5xl font-bold font-['Satoshi'] leading-tight lg:leading-[52.80px]">Who It&apos;s Built For</div>
      ...
      <section className="flex flex-col px-4 sm:px-8 lg:px-32 pt-12 sm:pt-16 lg:pt-24 pb-12 sm:pb-16 lg:pb-20 bg-gradient-to-b from-neutral-50 to-white border-b-2 border-gray-200">
        <div className="flex flex-col gap-8 sm:gap-12 lg:gap-16">
          <div className="text-center">
            <div className="text-neutral-900 text-3xl sm:text-4xl lg:text-5xl font-bold font-['Satoshi'] leading-tight lg:leading-[52.80px]">Core Principles</div>
      ...
      <footer className="flex flex-col sm:flex-row justify-between items-center px-4 sm:px-6 lg:px-9 py-8 sm:py-12 bg-white border-t-2 border-gray-200 gap-4">
        <div className="text-neutral-900 text-xl sm:text-2xl font-black">Wondrr</div>
