  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="w-full px-[1%]">
        <section className="relative w-full min-h-[88vh] flex flex-col justify-end px-9 py-16 gap-10 overflow-hidden rounded-3xl">
          <Image
            src="/png/P1.png"
            alt="Hero background"
            width={1920}
      ...
      <div className='flex flex-col justify-center mx-[6%]'>
        <section className="flex items-center justify-between gap-16 px-9 py-24 w-full">
          ...
          <div className="flex gap-3 flex-1">
            <div className="flex flex-col gap-3">
              <div className="relative p-6 bg-cover bg-center rounded-3xl overflow-hidden min-h-[292px]">
            ...
            <div className="flex flex-col gap-3 flex-1">
              <div className="relative p-6 bg-cover bg-center rounded-3xl overflow-hidden flex-1">
        ...
        <section className="flex flex-col gap-16 px-9 py-24 w-full">
          <div className='flex gap-4'>
            ...
            <h2 className="text-4xl font-medium w-[60%]">
          ...
          <div className='flex gap-16'>
            <div className="flex-1 max-w-md">
              <div className="relative p-8 bg-cover bg-center rounded-3xl overflow-hidden min-h-[450px] flex flex-col justify-end cursor-pointer hover:scale-[1.02] transition-transform">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/60 rounded-3xl" />
                <div className="relative flex flex-col">
                  <p className="text-white text-xl font-semibold leading-tight">
                    {CONTENT.faq.helpCard.text}
                  </p>
                  <p className='mb-4 text-white'>{CONTENT.faq.helpCard.answer}</p>
                  <button className="px-6 py-3 bg-white text-neutral-900 rounded-full font-bold self-start hover:bg-neutral-100 transition-colors">
            ...
            <div className="flex flex-col gap-10 flex-1">
              <div className="flex flex-col gap-4">
                {CONTENT.faq.questions.map((item, idx) => (
                  <div
                    key={idx}
                    className="p-6 bg-neutral-50 rounded-3xl cursor-pointer hover:bg-neutral-100 transition-colors"
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className={`w-6 h-6 flex items-center justify-center transition-transform ${expandedFaqIndex === idx ? 'rotate-180' : ''
                        }`}>
                    ...
                    {expandedFaqIndex === idx && (
                      <p className="text-neutral-700 text-base font-medium mt-3">
                        {item.answer}
                      </p>
                    )}
                  </div>
        ...
        <section className="px-10 py-24 bg-neutral-50 rounded-3xl flex gap-10 w-full">
          <div className="flex flex-col justify-between flex-1">
          ...
          <div className="flex gap-2 flex-1">
            <div className="rounded-3xl overflow-hidden flex-1">
              <MyImage width={370} height={378} src="https://placehold.co/370x378" alt="CTA 1" className="w-full h-full object-cover" />
            </div>
            <div className="rounded-3xl overflow-hidden flex-1">
              <MyImage width={370} height={315} src="https://placehold.co/370x315" alt="CTA 2" className="w-full h-full object-cover" />
            </div>
          </div>
        </section>
      </div>

      <footer className="flex flex-col gap-12 py-24 w-full bg-neutral-900 border-t border-neutral-800">
        <div className="flex justify-between gap-16 px-9 max-w-[1520px] w-full mx-auto">
          <div className="flex flex-col gap-6 flex-1 max-w-sm">
            <h3 className="text-3xl font-black text-white">Wondrr</h3>
            <p className="text-neutral-300 text-base font-medium">
              {CONTENT.footer.tagline}
            </p>
            <div className="flex gap-3">
              {CONTENT.footer.social.map((platform) => (
                <div key={platform} className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center cursor-pointer hover:bg-white/20 transition-colors">
                  {/* Social icon */}
                </div>
              ))}
            </div>
              ...
              <div key={section.title} className="flex flex-col gap-4">
                ...
                <ul className="flex flex-col gap-3">
                  {section.links.map((link) => (
                    <li key={link.label}>
                      <a href={link.href} className="text-neutral-400 text-base font-medium hover:text-white transition-colors">
                        {link.label}
                      </a>
                    </li>
                  ))}
        ...
        <div className="pt-8 border-t border-neutral-800 px-9 max-w-[1520px] w-full mx-auto">
          <p className="text-neutral-400 text-sm font-medium text-center">
