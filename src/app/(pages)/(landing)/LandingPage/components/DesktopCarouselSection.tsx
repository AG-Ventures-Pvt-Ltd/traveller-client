...
import DesktopSlidingCarousel from './DesktopSlidingCarousel';
import { SlidingCarouselSectionProps } from '../../HomePage/types';

const DesktopCarouselSection: React.FC<SlidingCarouselSectionProps> = ({
  title,
  description,
  trips,
  isLoading = false,
